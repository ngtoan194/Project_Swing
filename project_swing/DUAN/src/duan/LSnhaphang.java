 ...
 * @author Nguyen Toan
 */
public class LSnhaphang extends javax.swing.JDialog {

    private Connection cnt = new connectDB.connectDB().getConnection();

    public LSnhaphang(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void Loadhistory() {
        ...
        try {
            ...
            ResultSet rs = stm.executeQuery("SELECT PHIEUNHAP.MAPN,HOTEN,CONVERT(NVARCHAR,NGAYNHAP,101) FROM PHIEUNHAP INNER JOIN TAIKHOAN ON TAIKHOAN.TENTK=PHIEUNHAP.TENTK INNER JOIN CTPHIEUNHAP ON CTPHIEUNHAP.MAPN=PHIEUNHAP.MAPN WHERE PHIEUNHAP.STATUS = 1;");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        Lb_Title.setText("Lịch sử nhập hàng");
    ...
    private void Tbl_HistoryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tbl_HistoryMouseClicked
        new CTLSnhaphang(this, true,(Tbl_History.getValueAt(Tbl_History.getSelectedRow(), 0)).toString()).setVisible(true);
